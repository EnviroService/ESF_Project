...
class ResettingController extends AbstractController
{
    ...
    public function request(
        ...
        if($form->isSubmitted() && $form->isValid()) {
            ...
            if (!$user) {
                ...
                $mailUser = (new Email())
                    ->from(new Address('github-test@bipbip-mobile.fr', 'Enviro Service France'))
                ...
                $request->getSession()->getFlashBag()->add('success', "Un email va vous être envoyé afin que
    ...
    //si supérieur à 30min, retourne false
