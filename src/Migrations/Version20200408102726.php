 ...
 */
final class Version20200408102726 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rate_card CHANGE price_rate_card price_rate_card DOUBLE PRECISION NOT NULL');
